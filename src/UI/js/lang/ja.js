const LANG_JA = {
    ...
    vndbAutoFetch: 'メタデータを自動取得',
    vndbHint: '有効にすると、VN追加時に選択したソースからカバー、説明、タグ、評価を自動取得します。',
    proxyAddress: 'プロキシ',
    proxyHint: 'メタデータAPIリクエスト用のHTTPプロキシ（例: http://127.0.0.1:1080）。',
    proxyPlaceholder: 'http://ホスト:ポート',
    links: 'リンク',
    linkLabelPlaceholder: 'ラベル',
    linkUrlPlaceholder: 'https://...',
    metaSearch: 'メタデータを検索',
    metaSearching: 'メタデータを取得中...',
    ...
    tabLibrary: 'ライブラリ',
    tabVndb: 'VNDB',
    tabDataSources: 'データソース',
    tabData: 'データ',
    tabShortcuts: 'ショートカット',
    tabAbout: 'このアプリ',
    metadataProvider: 'データソース',
    ...
    skipMetaLabel: 'メタデータを自動取得しない',
    skipMetaHint: '有効にすると、このエントリのメタデータは自動的に取得されません。',
    ...
    colorBgElevated: '浮上',
    colorBgHover: 'ホバー',
    colorBorderColor: '境界線',
    colorTextPrimary: 'テキスト',
    colorTextSecondary: 'テキスト（補助）',
    colorHeart: 'ハート',
    colorStar: 'スター',
    colorDanger: 'デンジャー',
    colorSectionStatuses: 'ステータス',
    colorStatusReading: '読書中',
    colorStatusCompleted: '完了',
    colorStatusOnHold: '保留中',
    colorStatusDropped: '中断',
    colorStatusPlan: '読む予定',
    sidebarBackground: 'サイドバー背景',
    topbarBackground: 'トップバー背景',
    panelStyle: 'パネルスタイル',
    panelSurfaceOpacity: 'サーフェス不透明度',
    panelStyleHint: '不透明度を下げると、グローバル背景がパネルを通して見えます。',
    layoutSection: 'レイアウト',
    sidebarWidth: 'サイドバー幅',
    cardRadius: '角の丸み',
